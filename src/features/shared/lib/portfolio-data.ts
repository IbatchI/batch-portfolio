  ...
  experience: [
    {
      ...
      projects: [
        ...
        },
        {
          ...
          achievements: ["i18n", "animations", "performance", "formValidation", "containerization", "codeQuality"],
          tech: ["Next.js", "TypeScript", "Framer Motion", "i18next", "Zod", "React Hook Form", "shadcn/ui", "Docker", "SonarQube"],
          difficulty: {
            complexity: 70,
            scale: 45,
            duration: 2,
