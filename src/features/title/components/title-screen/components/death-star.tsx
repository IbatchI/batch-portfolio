...
export function DeathStar() {
  ...
  useEffect(() => {
    const showDeathStar = () => {
      setVisible(true);
      setTimeout(() => setVisible(false), DEATH_STAR_VISIBLE_DURATION_MS);
    };

    const interval = setInterval(
      showDeathStar,
      DEATH_STAR_INTERVAL_MIN_MS +
        Math.random() * DEATH_STAR_INTERVAL_RANDOM_MS,
    );
    const initialTimeout = setTimeout(
      showDeathStar,
      DEATH_STAR_INITIAL_DELAY_MS,
    );
  ...
  return (
    <div
      ...
      style={{
        animation: `ezioRun ${DEATH_STAR_ANIMATION_DURATION} linear forwards`,
      }}
